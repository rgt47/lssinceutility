...
![Streamlined file discovery workflow](media/ls_since_hero.png){.img-fluid width="50%"}
...
![Interactive exploration in action](media/flat-workspace-office-concept.png){.img-fluid width="50%"}
...
![Ready to explore your file system](media/technology-unicorn-venture-workspace-with-pc-used-conduct-code-reviews.jpg){.img-fluid width="50%"}
